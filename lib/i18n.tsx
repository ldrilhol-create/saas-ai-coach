...
const translations = {
  fr: {
    ...
    account: {
      ...
      changePlanCta: 'Changer de plan',
      changePlanSubtitle: 'Découvre tous les plans et passe au niveau supérieur en quelques clics.',
      ...
      prioritySupportEmail: 'buisnesscoachia@gmail.com',
    ...
    pricing: {
      ...
      cycleYearly: 'Annuel',
      cycleYearlyBadge: '–17 %',
      cycleYearlySubtitle: 'Soit {effective}€/mois · 2 mois offerts',
      ...
      trustCancel: 'Annulation en 1 clic',
      trustNoCommit: 'Sans engagement',
      trustData: 'Données hébergées en Europe',
      trustSupport: 'Support en français',
      includesTitle: 'Tous les plans incluent',
      upgradeEyebrow: 'Réactiver mon coach',
      upgradeTitle: 'Reprends ton parcours',
      upgradeSubtitle: 'Choisis le plan qui te correspond pour débloquer ton coach IA et continuer là où tu t\'étais arrêté.',
      upgradeBackToHome: 'Accueil',
      upgradeBackToProjects: 'Mes projets',
      upgradeNotNow: 'Pas maintenant',
      legalBackHome: 'Accueil',
      starterName: 'Starter',
      starterTagline: 'Pour démarrer sereinement',
      starterPrice: '29',
      starterF1: 'Coach IA de base',
      ...
      premiumPrice: '69',
      premiumF1: 'Coach IA Premium',
      premiumF2: '600 messages / mois',
    ...
    roadmap: {
      ...
      refineButton: 'Mettre à jour ma roadmap',
      refineModalTitle: 'Mettre à jour ta roadmap',
      refineModalSubtitle: 'Ton coach va rafraîchir ta roadmap en tenant compte de ce qui a évolué depuis. Gratuit, ne touche pas à ton quota.',
      refineQ1Label: 'Qu\'est-ce qui a changé depuis ta dernière roadmap ?',
      refineQ1Placeholder: 'Ex : j\'ai validé que mon idée intéresse, j\'ai trouvé ma vraie niche, j\'ai abandonné le côté SaaS...',
      refineQ2Label: 'Ton idée business actuelle (en 1 phrase claire)',
      refineQ2Placeholder: 'Ex : Une newsletter payante pour freelances UX qui veulent passer à 5k€/mois',
      refineQ3Label: 'Ton plus gros blocage maintenant',
      refineQ3Placeholder: 'Ex : je ne sais pas comment trouver mes 10 premiers abonnés payants',
      refineWarning: '⚠️ Ta roadmap actuelle sera remplacée. Les tâches déjà cochées seront réinitialisées (les nouvelles phases seront différentes).',
      refineSubmit: 'Mettre à jour ma roadmap',
      refineSubmitLoading: 'Mise à jour en cours...',
      refineCancel: 'Annuler',
      refineErrorEmpty: 'Décris au moins ce qui a changé',
      refineSuccessTitle: 'Roadmap mise à jour ✨',
      refineLimitTitle: 'Limite de mises à jour atteinte',
      refineLimitBody: 'Tu as atteint la limite de {limit} mises à jour ce mois sur ton plan {tier}. Reprise le 1er du mois prochain — ou passe à un plan supérieur pour plus de flexibilité.',
      refineLimitUpgrade: 'Voir les plans supérieurs',
      home: 'Accueil',
      signout: 'Déconnexion',
  ...
  en: {
    ...
    account: {
      ...
      changePlanSubtitle: 'See all plans and upgrade in a few clicks.',
    ...
    pricing: {
      ...
      cycleYearly: 'Yearly',
      cycleYearlyBadge: '–17%',
      cycleYearlySubtitle: '€{effective}/month equivalent · 2 months free',
      ...
      trustCancel: 'Cancel in one click',
      trustNoCommit: 'No commitment',
      trustData: 'Data hosted in Europe',
      trustSupport: 'Support in English',
      includesTitle: 'Every plan includes',
      upgradeEyebrow: 'Reactivate my coach',
      upgradeTitle: 'Pick up where you left off',
      upgradeSubtitle: 'Choose the plan that fits to unlock your AI coach and keep moving forward.',
      upgradeBackToHome: 'Home',
      upgradeBackToProjects: 'My projects',
      upgradeNotNow: 'Not now',
      legalBackHome: 'Home',
      starterName: 'Starter',
      starterTagline: 'For a steady start',
      starterPrice: '29',
      starterF1: 'Standard AI coach',
      ...
      premiumPrice: '69',
      premiumF1: 'Premium AI coach',
      premiumF2: '600 messages / month',
    ...
    roadmap: {
      ...
      refineButton: 'Refine my roadmap',
      refineModalTitle: 'Refine your roadmap',
      refineModalSubtitle: 'Your coach will refresh your roadmap based on what has evolved since. Free, doesn\'t use your quota.',
      refineQ1Label: 'What\'s changed since your last roadmap?',
      refineQ1Placeholder: 'E.g.: I validated my idea, I found my real niche, I dropped the SaaS angle...',
      refineQ2Label: 'Your current business idea (in one clear sentence)',
      refineQ2Placeholder: 'E.g.: A paid newsletter for UX freelancers who want to hit $5k/month',
      refineQ3Label: 'Your biggest blocker right now',
      refineQ3Placeholder: 'E.g.: I don\'t know how to get my first 10 paying subscribers',
      refineWarning: '⚠️ Your current roadmap will be replaced. Already-checked tasks will be reset (new phases will differ).',
      refineSubmit: 'Refine my roadmap',
      refineSubmitLoading: 'Refining...',
      refineCancel: 'Cancel',
      refineErrorEmpty: 'Tell us at least what has changed',
      refineSuccessTitle: 'Roadmap refreshed ✨',
      refineLimitTitle: 'Refresh limit reached',
      refineLimitBody: 'You\'ve hit the limit of {limit} refreshes this month on your {tier} plan. Resets on the 1st of next month — or upgrade for more flexibility.',
      refineLimitUpgrade: 'See higher plans',
      home: 'Home',
      signout: 'Sign out',
