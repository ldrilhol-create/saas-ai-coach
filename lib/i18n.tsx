...
const translations = {
  fr: {
    ...
    roadmap: {
      ...
      streakBestSuffix: 'Record perso : {best}',
      dailyBannerEyebrow: 'Ta tâche du jour',
      dailyBannerCta: 'Voir dans ma roadmap',
      dailyBannerDismiss: 'Plus tard',
      home: 'Accueil',
      signout: 'Déconnexion',
  ...
  en: {
    ...
    roadmap: {
      ...
      streakBestSuffix: 'Personal best: {best}',
      dailyBannerEyebrow: 'Today\'s task',
      dailyBannerCta: 'Show in my roadmap',
      dailyBannerDismiss: 'Later',
      home: 'Home',
      signout: 'Sign out',
